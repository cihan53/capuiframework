...
export default class BaseStore {
     ...
     */
    @action
    addModelRecord(key, record) {
        this._model.set(key, record);
    }
    ...
    @action setParameters(newParameters = {}) {
        this.parameters = Object.assign(this.parameters, newParameters);
    }
    ...
    @action getActionStatus(action) {
        return this.actionStatus.get(action);
    }
    ...
    load(params = {}) {
        ...
        if (!Utils.isEmpty(params)) {
            ...
            if (params.filters && CAP.Utils.isString(params.filters)) params.filters = JSON.stringify(params.filters);
            this.setParameters(params);
        }

        // console.debug("stores Base Params :", this.parameters);
        ...
        return this.Request.get(url)
            .then(action((res) => {
                ...
                if (res) {
                    ...
                    this.currentPage = this.parameters.page + 1;
                } else {
    ...
    @action save(params, isNewRecord = true, postType = "json") {
        ...
        return this.Request.post(this.baseUrl + this.Action.save, params, postType)
            .then(action((res) => {
                return res;
            }))
            .catch(action((err) => {
    ...
    @action update(params, postType = "json") {
        ...
        return this.Request.post(this.baseUrl + this.Action.update, params, postType)
            .then(action((res) => {
                return res;
            }))
            .catch(action((err) => {
    ...
    @action delete(params, postType = "formdata") {
        ...
        return this.Request.post(this.baseUrl + this.Action.delete, params, postType)
            .then(action((res) => {
                return res;
            }))
            .catch(action((err) => {
