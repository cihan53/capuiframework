...
export default class ElasticSql extends DriverInterface {
    _debug = false;
    _baseUrl = "";
    _currentId = 0;
    running = null;
    ...
    regenerateQuery() {
        this._select = [];
        this._joins = [];
        this._froms = [process.env.REACT_APP_DEFAULT_DATA_INDEX || "eventdata-preprod"];
        this._limit = null;
        this._start = 0;
        this._sqlText = "";
        this._where = null;
    ...
    build() {
        ...
        this._sqlText += " from " + this.table.join(", ");
